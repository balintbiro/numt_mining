...
descriptors=pd.Series([
		'Kmer type 1','Kmer type 2','RCKmer type 1','RCKmer type 2','Mismatch','Subsequence','NAC',
		'ANF','ENAC','binary','PS2','PS3','PS4','CKSNAP type 1','CKSNAP type 2','NCP','EIIP','PseEIIP',
		'ASDC','DBE','LPDF','DPCP','DPCP type2','TPCP','TPCP type2','MMI','Z_curve_9bit','Z_curve_12bit',
		'Z_curve_36bit','Z_curve_48bit','Z_curve_144bit','NMBroto','Moran','Geary','DAC','DCC','DACC',

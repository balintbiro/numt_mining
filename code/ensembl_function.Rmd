...
```
Create function for querying Ensembl.
First step, select the desired database, all available listEnsembl().
Select the desired dataset, all available listDatasets(ensembl).
Select the mirror, options -->useast,uswest,asia,www
```{r}
